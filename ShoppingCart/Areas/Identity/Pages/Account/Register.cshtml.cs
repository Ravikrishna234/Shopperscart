...
namespace ShoppingCart.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        // Added to access role entity in SSMS
        ...
        public class InputModel
        {
            ...
            // To create dropdown on user Registration 
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                ...
                StateList = StaticDetails.STATES.Select(x => new SelectListItem
                {
                    Text = x,
                    Value = x
                })
            ...
            // No need of savechanges it do automatically
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // If user account is created add the role to userrole table
